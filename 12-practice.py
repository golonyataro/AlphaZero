...
plt.plot([0, 0], [0, 3], color='k')
plt.plot([3, 3], [2, 0], color='k')
plt.plot([1, 1], [1, 3], color='k')
plt.plot([4, 4], [4, 1], color='k')
plt.plot([1, 2], [2, 2], color='k')
plt.plot([2, 2], [2, 0], color='k')
plt.plot([4, 2], [3, 3], color='k')
...
def animate(i):
  ...
  circle.set_data((state % 4) + 0.5, 3.5 - int(state / 4))
  return circle
